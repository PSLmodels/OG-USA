...
def main():
    ...
    op.plot_all(
        base_dir, reform_dir, os.path.join(CUR_DIR, "OG-USA_current_policy_example_plots_tables")
    )
    ...
    ans.to_csv(os.path.join(CUR_DIR, "OG-USA_current_policy_example_plots_tables", "ogusa_example_output.csv"))
