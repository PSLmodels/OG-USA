...
### Default Tax Functional Form
  ...
  * - SSE
  ...
  The full set of estimated values are calculated using the [`get_tax_function_parameters`](https://github.com/PSLmodels/OG-USA/blob/master/ogusa/calibrate.py#L82) and []() methods of the [`Calibration`](https://github.com/PSLmodels/OG-USA/blob/master/ogusa/calibrate.py#L20) class  of the [`OG-USA/ogusa/calibrate.py`](https://github.com/PSLmodels/OG-USA/blob/master/ogusa/calibrate.py#L20) module. And the estimated baseline values are stored in the [`ogusa_default_parameters.json`](https://github.com/PSLmodels/OG-USA/blob/master/ogusa/ogusa_default_parameters.json) file.
